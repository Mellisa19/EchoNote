    ...
    <div className="min-h-screen bg-brand-dark text-white overflow-hidden relative flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <p className="mt-3 text-center text-gray-400">
          Access your AI-powered meeting intelligence
        </p>
      </div>
        ...
        <Card variant="glass" className="py-10 px-4 sm:px-10 border-white/5 shadow-2xl">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm font-medium">
              <span className="px-4 bg-[#1A1128] text-gray-500 rounded-full">Or sign in with email</span>
            </div>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="text-sm">
                  <button
                    ...
                    className="font-bold text-brand-purple hover:text-brand-pink transition-colors"
                  >
                    Forgot password?
                  </button>
                </div>
            ...
            <div className="flex items-center">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-3 block text-sm font-bold text-gray-400">
                  Stay signed in
                </label>
              </div>
            </div>
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm font-medium">
                <span className="px-4 bg-brand-dark text-gray-400">Or continue with</span>
              </div>
            </div>
            ...
            <div className="mt-6">
              <button
                ...
                disabled={isGoogleLoading}
                className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white/5 border border-white/10 rounded-2xl text-white font-bold hover:bg-white/10 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isGoogleLoading ? (
                  <LoadingSpinner size="sm" />
                ) : (
          ...
          <div className="mt-10 text-center">
            <p className="text-gray-400 font-medium">
              ...
              <Link to="/signup" className="font-bold text-brand-purple hover:text-brand-pink transition-colors">
                Sign up for free
              </Link>
            </p>
          </div>
